...
const SkilledModifyDetails = ({
  ...
  const getDetails = async () => {
    try {
      ...
      if (newDetails.SelectSkill) setSkill(newDetails.SelectSkill);
      if (newDetails.Password) setPassword(newDetails.Password);
    } catch (error) {
      console.error("Error fetching skilled details:", error);
    }
  };
  ...
  const handleUpdate = async () => {
    if (!fullName || !mobile || !location || !skill || !password) {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        >
          <Text style={styles.screenTitle}>Edit Skilled Profile</Text>
...
export default SkilledModifyDetails;
